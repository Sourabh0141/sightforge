...
export const FilterXIcon: React.FC<IconProps> = ({
  size = 16,
  className = "",
  ...props
}) => (
...
export const ClockAlertIcon: React.FC<IconProps> = ({
  size = 16,
  className = "",
  ...props
}) => (
...
export const Code2Icon: React.FC<IconProps> = ({
  size = 16,
  className = "",
  ...props
}) => (
...
export const FileImageIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="m20 17-3.5-3.5a1.5 1.5 0 0 0-2.12 0L9 19" />
  </svg>
);

export const RotateCwIcon: React.FC<IconProps> = ({
  size = 16,
  className = "",
  ...props
}) => (
