...
- [ ] 5 · **P1 U2** — result contract package, generating TypeScript + Pydantic
...
- [ ] 10 · **P2 U1** — Worker configs, bindings, secrets, asset Worker
- [ ] 11 · **P2 U2** — shared middleware + Counter Durable Object ← **critical path, don't rush**
- [ ] 12 · **P2 U3** — authentication Worker
...
- [ ] 24 · **Stitch design** — landing page and app shell first, then the remaining screens
- [ ] 25 · **P4 U1** — application shell, design system, state primitives, `_headers`
